...
class ModsMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		noModsTxt.setFormat(Paths.font("RAVIE.TTF"), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		buttonToggle.label.setFormat(Paths.font("RAVIE.TTF"), 24, FlxColor.WHITE, CENTER);
		...
		buttonUp.label.setFormat(Paths.font("RAVIE.TTF"), 24, FlxColor.BLACK, CENTER);
		...
		buttonDown.label.setFormat(Paths.font("RAVIE.TTF"), 24, FlxColor.BLACK, CENTER);
		...
		buttonTop.label.setFormat(Paths.font("RAVIE.TTF"), 24, FlxColor.BLACK, CENTER);
		...
		buttonDisableAll.label.setFormat(Paths.font("RAVIE.TTF"), 24, FlxColor.BLACK, CENTER);
		...
		buttonEnableAll.label.setFormat(Paths.font("RAVIE.TTF"), 24, FlxColor.BLACK, CENTER);
		...
		installButton.label.setFormat(Paths.font("RAVIE.TTF"), 16, FlxColor.WHITE, CENTER);
		...
		removeButton.label.setFormat(Paths.font("RAVIE.TTF"), 16, FlxColor.WHITE, CENTER);
		...
		descriptionTxt.setFormat(Paths.font("RAVIE.TTF"), 32, FlxColor.WHITE, LEFT);
